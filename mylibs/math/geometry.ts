...
export function lineNormal(lineStart, lineEnd) : ICoordinate {
...
export function expandBoundsByPoint(topLeft : ICoordinate, bottomRight : ICoordinate, point:ICoordinate) {
...
export function arePointsClose(point1:ICoordinate, point2:ICoordinate) {
...
export function areValuesClose(value1:number, value2:number) {
    return areValuesCloseWithOptions(value1, value2, PointClosenessThreshold);
}

export function areValuesCloseWithOptions(value1:number, value2:number, threshold:number) {
...
export function rangeHasConverged(range: IRange, places: number) {
