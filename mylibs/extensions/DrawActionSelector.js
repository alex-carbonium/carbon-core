...
export default class DrawActionSelector extends ExtensionBase {
    attach(app, view, controller) {
        ...
        this._rectCreator = new ElementDragCreator(app, 'Rectangle');
        this._artboardCreator = new ElementDragCreator(app, Artboard);
        this._sectionCreator = new SectionCreator(app);
        this._circleCreator = new ElementDragCreator(app, 'Circle');
        this._polylineCreator = new GraphicalPathCreator(app, 'Path');
        this._starCreator = new ElementDragCreator(app, 'Star');
        this._polygonCreator = new ElementDragCreator(app, 'Polygon');
        this._triangleCreator = new ElementDragCreator(app, 'Polygon', {pointsCount: 3});
